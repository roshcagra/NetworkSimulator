...
Link(l_id = 2, link_rate=(1.25 * 10 ** 6), link_delay=10, max_buffer_size=128000, env=env),
Link(l_id = 3, link_rate=(1.25 * 10 ** 6), link_delay=10, max_buffer_size=128000, env=env),
Link(l_id = 4, link_rate=(1562500), link_delay=10, max_buffer_size=128000, env=env),
...
data3 = 30 * 10 ** 6
# data3 = 1024 * 2000
p = env.process(flow(data3, 20000, devices[4], 5, env, 'Reno'))
